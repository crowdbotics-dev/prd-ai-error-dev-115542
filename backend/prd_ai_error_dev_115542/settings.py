"""
Django settings for prd_ai_error_dev_115542 project.
...
ROOT_URLCONF = 'prd_ai_error_dev_115542.urls'
...
WSGI_APPLICATION = 'prd_ai_error_dev_115542.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_ai_error_dev_115542 API",
    "DESCRIPTION": "API documentation for prd_ai_error_dev_115542 App",
    "VERSION": "v1",
}
